...
class AutoLocatorImpl implements AutoLocator {
	...
	first(): AutoLocator {
		return new AutoLocatorImpl(this.getContainer, this.predicates, { type: 'first' });
	}

	last(): AutoLocator {
		return new AutoLocatorImpl(this.getContainer, this.predicates, { type: 'last' });
	}

	nth(index: number): AutoLocator {
		return new AutoLocatorImpl(this.getContainer, this.predicates, { type: 'nth', index });
	}
