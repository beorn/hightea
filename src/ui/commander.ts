 ...
 * import { colorizeHelp } from "silvery/ui/commander"
 *
...
interface CommandLike {
	configureHelp(configuration: Record<string, unknown>): unknown
	configureOutput(configuration: Record<string, unknown>): unknown
