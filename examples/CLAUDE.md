...
1. **Show, don't tell.** A showcase should demonstrate hightea features through working UI, not walls of text. Intro text is fine — but collapse it once the demo starts.
