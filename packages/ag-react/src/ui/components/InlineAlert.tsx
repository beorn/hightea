 ...
 * as a single inline row with a variant-colored icon and text. No background
 * fill, no dismiss affordance, no modal behavior — just a variant-tinted
 ...
 * Usage:
 * ```tsx
 * <InlineAlert variant="error">Type-check failed in src/app.ts</InlineAlert>
 * <InlineAlert variant="warning" icon="⚠">Deprecated API</InlineAlert>
 * <InlineAlert variant="info" showIcon={false}>Quiet notice</InlineAlert>
 * ```
 */
...
export function InlineAlert({
  ...
  const color = variantFgToken(variant)
