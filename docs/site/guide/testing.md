...
hightea includes a comprehensive test suite with **870+ tests** covering everything from low-level buffer operations to high-level React component rendering. This guide documents the test structure and how to use `createRenderer` for testing your own hightea applications.
...
The `createRenderer` function provides an ink-testing-library compatible API for testing hightea components.
