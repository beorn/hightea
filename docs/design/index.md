...
Architecture decisions and technical design documents for Silvery's internals.

## Architecture

- [App Composition](/design/app-composition) -- How silvery apps are built, piece by piece
- [Plugin Architecture](/design/plugin-architecture) -- Plugin functions and `pipe()` composition
