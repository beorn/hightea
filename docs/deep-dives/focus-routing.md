...
Prescribed pattern for command-driven apps built on hightea. Routes all keyboard input through a centralized command/keybinding system using context predicates instead of per-component key handlers.
