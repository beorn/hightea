---
url: /guide/input-architecture.md
---
# Input Architecture
...
* **REPORT\_EVENTS** (2) -- press, repeat, and release events
* **REPORT\_ALL\_KEYS** (8) -- even plain letters get `CSI u` encoding, enabling modifier-only detection
