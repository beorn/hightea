...
*Synchronous rerender throughput, mocked stdout. Reproduce: `bun run bench`. See [detailed benchmarks](/guide/silvery-vs-ink#performance-size) for methodology.*
