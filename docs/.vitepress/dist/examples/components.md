---
url: /examples/components.md
description: >-
  Kitchen-sink showcase of Silvery's component library — Tabs, SelectList,
  CommandPalette, ModalDialog, Toast, TreeView, Badge, Spinner, ProgressBar, and
  more.
---
