---
url: /examples/ai-chat.md
description: >-
  Build terminal-based AI coding agents with scrollable output, streaming
  responses, tool call rendering, and Playwright-style testing using Silvery.
---
