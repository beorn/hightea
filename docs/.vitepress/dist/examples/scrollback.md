---
url: /examples/scrollback.md
description: >-
  Silvery's unique scrollback system — inline mode rendering,
  ScrollbackList/ScrollbackView, freeze-and-scroll, and natural terminal
  scrolling.
---
